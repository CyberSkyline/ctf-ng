...
class AdminStatsCounts(Resource):
    ...
    def get(self):
        ...
        if "error" in result:
            return {"success": False, "errors": {"counts": result["error"]}}, 400
        else:
            return {"success": True, "data": result}, 200
    ...
    def post(self):
        ...
        if confirmation != "DELETE_ALL_DATA":
            return {
                "success": False,
                "errors": {
                    "confirmation": "You must send 'confirm': 'DELETE_ALL_DATA' to proceed with this destructive operation"
                },
            }, 400
        ...
        if result["success"]:
            ...
            return {"success": False, "errors": {"reset": result["error"]}}, 500
...
class AdminWorldReset(Resource):
    ...
    def post(self, world_id):
        ...
        if confirmation != "DELETE_WORLD_DATA":
            return {
                "success": False,
                "errors": {"confirmation": "You must send 'confirm': 'DELETE_WORLD_DATA' to proceed"},
            }, 400
        ...
        if result["success"]:
            ...
            return {"success": False, "errors": {"reset": result["error"]}}, (
                400 if "does not exist" in result["error"] else 500
            )
...
class AdminCleanup(Resource):
    ...
    def post(self):
        ...
        if result["success"]:
            ...
            return {"success": False, "errors": {"cleanup": result["error"]}}, 500
...
class AdminHealth(Resource):
    ...
    def get(self):
        ...
        if "error" in counts or not detailed["success"]:
            return {
                "success": False,
                "errors": {"health": "Unable to fetch system statistics"},
            }, 500
        ...
        return {"success": True, "data": health_report}, 200
