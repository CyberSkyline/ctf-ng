...
GET_SUBMISSION_HISTORY_DOC = {
    "description": "Get submission history including all scoring events, attempts, hint redemptions, and manual awards with names (Admin only)",
    "params": {
        "limit": {
            "description": "Maximum number of score events and manual awards to return (attempts and hint redemptions return all)",
            "required": False,
            "type": "integer",
            "example": 100,
            "default": 100
    ...
    "responses": {
        200: "Success - Returns submission history with enriched names for all scoring activity",
        400: "Bad request - Invalid limit parameter (must be 1-1000)",
        **ADMIN_REQUIRED_RESPONSES,
