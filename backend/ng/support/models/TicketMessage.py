"""
/backend/ng/support/models/TicketMessage.py
...
class TicketMessage(db.Model):
    ...
    @classmethod
    def find_by_id(cls, message_id: int) -> Optional['TicketMessage']:
    ...
    @classmethod
    def get_first_admin_message(cls, ticket_id: int) -> Optional['TicketMessage']:
        ...
        return cls.query.join(Users).filter(
            cls.ticket_id == ticket_id,
            Users.type == 'admin'
