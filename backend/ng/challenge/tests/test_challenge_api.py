...
def test_challenge_import_endpoint(admin_client):
...
""")
    ...
    response = admin_client.post("/ng/admin/challenge/import", json={"yaml": yaml.decode("utf-8")})
...
def test_challenge_import_endpoint_bad_yaml(admin_client):
    yaml = base64.urlsafe_b64encode(b"""
x-challenge:
  description: A simple challenge to test parsing
  icon: TbPuzzle
