"""
/backend/ng/user/routes/users.py
...
from ...core.middleware import authed_user_required, handle_integrity_error
...
class UserList(Resource):
    ...
    @users_namespace.doc(
        description="Get a list of all users with extended details (Admin only)",
        responses={
