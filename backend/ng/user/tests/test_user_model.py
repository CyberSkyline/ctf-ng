...
class TestUser:
    ...
    def test_serialize_with_admin_fields(self, user_factory):
        ...
        """
        ng_user = user_factory(name="Admin Serialize", email="admin_serialize@example.com")
    ...
    def test_serialize_missing_ctfd_user(self, db_session):
        """
    ...
    def test_check_can_join_team_in_event_false(self, user_factory, event_factory, team_factory):
        """
    ...
    def test_delete_all_users(self, db_session, user_factory):
        """
    ...
    def test_ctfd_user_relationship(self, user_factory):
        ...
        """
        ng_user = user_factory(name="Relationship Test", email="relationship@example.com")
