          ...
          {selectedOption === 'existing' ? (
            <FormDropdown
              ...
              options={[
                ...
                {
                  name : 'cat',
                  value : 'https://vgl.ucdavis.edu/sites/g/files/dgvnsk15116/files/media/images/Bengal%20cat.jpg',
                  icon : <TbHeartHandshake />,
                },
                {
                  name : 'dog',
                  value : 'https://vgl.ucdavis.edu/sites/g/files/dgvnsk15116/files/media/images/shutterstock_334888937.jpg',
                  icon : <TbHeartHandshake />,
                },
                {
                  name : 'horse',
                  value : 'https://vgl.ucdavis.edu/sites/g/files/dgvnsk15116/files/inline-images/Horse-Palomino-Cream-Dilution-Close-Crop-600px.jpg',
                  icon : <TbHeartHandshake />,
                },
              ]}
              control={control}
